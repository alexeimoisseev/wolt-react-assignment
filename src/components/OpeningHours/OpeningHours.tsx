...
import convertOpeningHours, { daysOfWeekSorted, isToday } from './convertOpeningHours';
...
export default function OpeningHours() {
  ...
  return <div className="OpeningHours">
    <div className="OpeningHours__header">
      ...
      <div className="OpeningHours__headerCaption">
        Opening hours
      </div>
    </div>
    ...
    <div className="OpeningHours__items">
      {
        daysOfWeekSorted.map(day => {
          return <TableItem key={day} dayOfWeek={day} value={t[day]} isToday={isToday(day)} />
        })
      }
    </div>
  </div>;
